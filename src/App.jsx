...
const LAST_UPDATED = "March 9, 2026 — 7:44 PM IST (Day 10 • Brent $120 • Nifty in CORRECTION)";
...
const INDIA_REGIONS = [
  ...
  },
  {
    ...
    tag: "HIGH",
    detail: "Jaishankar: serious supply chain disruption. Brent $120 intraday (G7 SPR talks pared to $103). MOJTABA KHAMENEI in power, IRGC loyal. Hegseth: 500-2000lb bombs next. HRW: Israel used WHITE PHOSPHORUS in Lebanon. Lebanon 394 killed (83 children). Bahrain FORCE MAJEURE. Saudi warned ready to self-defend. Senate Dems condemned school strike. 52,000 Indians returned. Trump: oil price small price to pay.",
  },
  {
...
const GEOPOLITICAL_CHALLENGES = [
  {
    ...
    items: [
      ...
      { text: "Brent $119.50→$120 intraday → $103.54 close (G7 discussing IEA SPR release pared gains). US crude +35% last wk (biggest since 1983). 20M bbl/day off market. Bahrain FORCE MAJEURE. WTI $101. US gas $3.45/gal (+43c). Rapidan: could test $120 in 2 wks. CSIS: Epic Fury costs $891M/DAY ($3.7B total so far)", metric: "$78", unit: "Brent Tue" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "MOJTABA KHAMENEI in power, IRGC pledged allegiance. Iran FM REJECTS ceasefire. Hegseth: war could last 8 WEEKS. HRW: Israel used WHITE PHOSPHORUS in Lebanon. Senate Dems condemned school strike", metric: "⚡", unit: "escalation" },
      { text: "52,000 Indians returned Mar 1-7 (MEA). 32,000 Americans evacuated. US ordered non-emergency staff out of Saudi Arabia. Saudi warned it will defend itself. G7 finance ministers meeting on SPR release", metric: "9M+", unit: "citizens" },
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff1744" }}>DAY 10 CLOSE — BRENT $120, NIFTY IN CORRECTION:</strong> Brent hit $119.50→$120 intraday before G7 SPR release discussion pared to $103.54 close. Sensex CLOSED -1,353 at 77,566 (intraday crashed -2,494 to 76,425 = lowest since Apr 2025). Nifty CLOSED -422 at 24,028 (intraday -753 to 23,698). NIFTY NOW 10% OFF RECORD HIGH = ENTERED TECHNICAL CORRECTION. ₹8.5L cr wiped at close (₹12.78T intraday). Rupee NEW ALL-TIME LOW 92.50/$. VIX past 24. Nikkei -6.82%. Kospi -9% (circuit breaker). MOJTABA KHAMENEI now Supreme Leader. IRGC pledged allegiance. Hegseth: war could last 8 WEEKS. Bahrain declared FORCE MAJEURE on oil operations. HRW: Israel used WHITE PHOSPHORUS in Lebanon. Lebanon: 394 killed (83 children). Iran IRIS Dena: 104 dead (revised up). Saudi intercepted drone at Shaybah oilfield + warned of self-defense. 2 Bangladeshis killed Saudi. Senate Dems condemned school strike. 6 top Dem senators: "horrified." Trump: oil price is small price to pay. G7 finance ministers meeting today on joint SPR release.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff9100" }}>INDIA IN CORRECTION — ₹38L+ CR DESTROYED:</strong> Sensex 77,566 (-1,353 Mon, Apr 2025 low). Nifty 24,028 (-422, intraday 23,698). NIFTY 10% OFF RECORD = CORRECTION. Intraday: Sensex crashed 2,494 pts to 76,425 before partial recovery. ₹8.5L cr wiped Mon alone. TOTAL since war: ~₹38L+ cr destroyed across 4 trading sessions. Rupee hit NEW ATL 92.50/$. VIX past 24 (+21%). PSU Bank -6%. Bank Nifty -2,192 (-3.8%). SBI -5%. IndiGo -8%. Only ONGC + Coal India green. FII sold ₹21,831 cr in Mar so far. LPG hiked ₹60/cyl Saturday. UBS downgraded all OMCs. Nomura: FMCG margins at risk. Jaishankar: "serious supply chain disruption" likely. At Brent $100+: petrol ₹100+/L imminent, CAD blowout, RBI rate cuts impossible, rupee heading 93-95.</p>
                <p style={{ margin: "0 0 6px" }}>
                ...
                <p style={{ margin: 0 }}>
                  <strong style={{ color: "#00e5ff" }}>10-DAY TRAJECTORY — ATTRITION WAR, NO EXIT:</strong> Oil: $65→$78→$87→$94→$120 intraday ($103 close on G7 SPR hope). Deaths: 555→787→1,045→1,332 Iran + 394 Lebanon = 1,754+ TOTAL. New Supreme Leader. Ceasefire REJECTED. 500-2000lb bombs coming. White phosphorus confirmed. Bahrain force majeure. War could last 8 WEEKS (Hegseth). India's FIVE CRISES at MAXIMUM SEVERITY: (1) ENERGY: Brent $120 intraday. Bahrain force majeure. Qatar LNG halted. 20M bbl/day off market; (2) FISCAL: ₹38L+ cr destroyed. Rupee 92.50 ATL. LPG +₹60. Petrol ₹100+ imminent; (3) MARKETS: NIFTY IN CORRECTION (10% off high). PSU Bank -6%. FII sold ₹21,831 cr; (4) TRADE: 400K tons rice stuck. Hormuz sealed. Shipping 8x; (5) SOCIAL: 52K evacuated vs 9M in Gulf. Jaishankar warns supply disruption. ONLY HOPE: G7 SPR release (pared Brent from $120 to $103). India MUST demand SPR coordination + emergency Russian crude + fiscal package + prepare for $100+ oil for weeks.</p>
              </div>
            </div>
          </div>
        )}

...
const LAST_UPDATED = "March 9, 2026 — 2:06 PM IST (Day 10 • Brent $120 • CORRECTION ZONE)";

// 👇 Add a new line at the TOP each day (most recent first)
const UPDATE_LOG = [
  { date: "Mar 9 (LIVE)", change: "MARKETS BLOODBATH: Sensex OPEN -1,862 to 77,057 (intraday -2,300). Nifty OPEN -582 to 23,868 (now ~23,914). NIFTY DOWN 10% FROM RECORD HIGH — ENTERED CORRECTION ZONE. ₹13.5L cr wiped morning. VIX +21%. Brent hit $119.50 INTRADAY (pared to $108 on G7 SPR release talk — FT). WTI $113. Auto -4.56%. PSU Bank worst. Indian Oil -6.38%. UBS DOWNGRADED OMCs. Nikkei -6.82% (-3,795 pts). Kospi circuit breaker AGAIN. Dow futures -1,026 (-2.33%). Jaishankar: serious supply chain disruption likely. Kuwait/UAE/Iran cut oil production. Bahrain: 32 wounded incl 2-month-old infant. Trump: oil price is small price to pay. Mojtaba Khamenei: IRGC pledges allegiance. Explosions continue Qom + Tehran.", severity: "critical" },
  { date: "Mar 9 (AM)", change: "DAY 10 — BRENT HIT $119.50 (pared to $108 on G7 SPR talk). Brent HIT $119.50 INTRADAY Mon (pared $108 on G7 SPR talk). WTI $113. Kuwait/UAE/Iran CUT production. Dow futures -1,026. US gas $3.45/gal (+43c since war). Rapidan: 20% global oil disrupted 9 days running (2x Suez Crisis record). MOJTABA KHAMENEI elected new Supreme Leader (Mar 8). IRGC + top leaders pledge allegiance. Trump: he is a lightweight. Iran FM Araghchi REJECTS ceasefire on Meet the Press. US death toll: 8 (7 combat + 1 health). 1,332+ dead Iran. Israel: 2,500 strikes, 80% air defense destroyed, near-complete air superiority. Israel struck OIL DEPOTS (Shahran, Shar Rey) for FIRST TIME — blackened rain on Tehran. Bahrain water desalination plant hit. Saudi Arabia: FIRST 2 deaths + 12 injured (residential). Hegseth: 500-2000lb bombs coming. HRW: school strike = war crime. UN: conflict is major humanitarian emergency (25M refugees). NIC report: war unlikely to topple Iran govt. CSIS: Epic Fury cost $3.7B ($891M/day). Pope Leo XIV calls for end to violence. Switzerland: US-Israel strikes violate international law. China FM Wang Yi: flames of war risk spreading. INDIA: 52,000 Indians returned Mar 1-7 (MEA). Sensex worst week in 1 yr (-3%). Nifty 24,450 (Apr 2025 low). Brent $87→$94→$108. GIFT Nifty -300 pts for Mon. Rupee 91.54 (recovered Thu from 92.30 ATL).", severity: "critical" },
...
const INDIA_REGIONS = [
  ...
  },
  {
    ...
    immediate: 99, shortterm: 97, medterm: 92, longterm: 85,
    tag: "CRITICAL",
  ...
  },
  {
    ...
    tag: "HIGH",
    detail: "Jaishankar: serious supply chain disruption likely. Brent $119.50 intraday (pared $108 on G7 SPR release talk). MOJTABA KHAMENEI: IRGC pledges allegiance. Hegseth: 500-2000lb bombs next. Trump: oil price small price to pay. NIC: war unlikely to topple regime. 52,000 Indians returned. UBS downgraded OMCs. Nomura: FMCG margins at risk. Oil $108-120 = worst macro shock since 2008.",
  },
  {
...
const GEOPOLITICAL_CHALLENGES = [
  {
    ...
    items: [
      ...
      { text: "Brent $119.50 intraday → $108 (G7 SPR release discussed — FT). WTI $113. US crude +35% last wk (biggest since 1983). 20M bbl/day off market. WTI $101. US gas $3.45/gal (+43c). Rapidan: could test $120 in 2 wks. CSIS: Epic Fury costs $891M/DAY ($3.7B total so far)", metric: "$78", unit: "Brent Tue" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "MOJTABA KHAMENEI elected 3rd Supreme Leader (Mar 8). Iran FM REJECTS ceasefire. Israel achieved near-complete air superiority (2,500 strikes, 80% air defense destroyed). HRW: school strike = war crime", metric: "⚡", unit: "escalation" },
      { text: "52,000 Indians returned Mar 1-7 (MEA). Kashmir schools reopened Mar 7. But: Hegseth promises 500-2000lb bombs next. Larijani warns of US ground invasion. NIC: war unlikely to topple regime", metric: "9M+", unit: "citizens" },
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff1744" }}>DAY 10 LIVE — BRENT $119.50, MARKETS IN FREEFALL:</strong> Brent crude hit $119.50 intraday Mon before paring to $108 on G7 SPR release discussion (FT). WTI $113. US crude +35% last week (biggest weekly gain since 1983). Kuwait/UAE/Iran CUT production. Sensex -1,862 to 77,057 (intraday -2,300). Nifty -582 to 23,868. NIFTY DOWN 10% FROM RECORD = ENTERED CORRECTION ZONE. ₹13.5L cr wiped morning. Nikkei -6.82% (-3,795 pts). Kospi CIRCUIT BREAKER triggered AGAIN. Dow futures -1,026. MOJTABA KHAMENEI elected Supreme Leader (Mar 8), IRGC pledges allegiance. Iran FM REJECTS ceasefire. Explosions continue in Qom + Tehran. Bahrain: 32 wounded incl 2-mo infant. Saudi: 2 killed (first deaths). Trump: oil rise is "small price to pay." Hegseth: 500-2000lb bombs next phase. Jaishankar: serious supply chain disruption likely. DEATH TOLL: 1,332+ Iran, 50+ Lebanon, 11 Israel, 8 US, 7+ Gulf = 1,408+ TOTAL.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff9100" }}>INDIA IN CORRECTION ZONE — WORST SINCE COVID:</strong> Sensex -1,862 to 77,057 (intraday -2,300). Nifty -582 to 23,868. NIFTY 10% OFF RECORD HIGH = TECHNICAL CORRECTION ZONE. ₹13.5L cr wiped Monday AM alone. TOTAL since war: ₹29.5L+ cr destroyed. VIX +21%. Auto -4.56%. Indian Oil -6.38%. UBS DOWNGRADED OMCs (IOC/BPCL neutral, HPCL sell). Nomura: FMCG margins at risk from commodity inflation. Brent hit $119.50 intraday before G7 SPR release talk pared to $108. Nikkei -6.82%. Kospi circuit breaker. Jaishankar: serious supply chain disruption. CRITICAL: if Brent stays $100+ for 2+ weeks, India faces (a) petrol ₹100+/L, (b) CAD blowout, (c) RBI rate cuts impossible, (d) rupee retests 93-95 zone, (e) FII exodus accelerates. Goldman CEO Solomon was right: markets need weeks to digest this.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ffea00" }}>EVACUATION + SOCIAL UPDATE:</strong> MEA: 52,000 Indians returned Mar 1-7 (32,107 on Indian carriers). Airspace gradually reopening. More flights planned. Kashmir schools reopened Mar 7. Thu saw brief market relief on nuclear diplomacy signals. BUT: 9M Indians still in Gulf. Brent $108 threatens Gulf economy. Saudi first deaths (2 killed residential). Bahrain desalination plant hit. Kuwait airport fuel storage targeted. 400K tons rice stuck. Gulf remittances $35B/yr at risk. Iran FM rejects ceasefire. Hegseth promises heavier munitions. No de-escalation in sight.
                </p>
                <p style={{ margin: 0 }}>
                  <strong style={{ color: "#00e5ff" }}>10-DAY TRAJECTORY — NO EXIT RAMP, ATTRITION WAR:</strong> Oil: $65 pre-war → $78 → $84 → $87 → $94 → $108 → $119.50 INTRADAY. Deaths: 555 → 787 → 1,045 → 1,332 → 1,408+. New Supreme Leader. Ceasefire rejected. 500-2000lb bombs coming. NIC says war won't topple regime. This is now an ATTRITION WAR with no exit ramp. India's FIVE CRISES at MAXIMUM: (1) ENERGY: Brent $119.50 intraday. 20M bbl/day off market. Qatar LNG halted. 8-wk buffer depleting; (2) FISCAL: Each $10 = CAD +50bps. Petrol ₹100+ imminent. OMC losses unsustainable. RBI cuts dead; (3) MARKETS: CORRECTION ZONE. ₹29.5L+ cr gone. UBS downgrades. VIX +40% week; (4) TRADE: 400K tons rice stuck. Hormuz sealed. Shipping costs 8x; (5) SOCIAL: 52K evacuated but 9M in Gulf. Jaishankar warns of supply chain disruption. ONLY HOPE: G7 discussing IEA SPR release (FT report pared Brent from $119 to $108). India MUST demand inclusion in SPR coordination.</p>
              </div>
            </div>
          </div>
        )}

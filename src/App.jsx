...
const LAST_UPDATED = "March 12, 2026 — 11:32 AM IST (Day 13 • Brent $101 • SPR FAILED)";
...
const INDIA_REGIONS = [
  ...
  },
  {
    ...
    tag: "HIGH",
    detail: "DAY 13: Tue de-escalation signal REVERSED. Iran most intense operation since war. IRGC+Hezbollah joint 5hr attack (50+ Israeli targets). 3 ships hit Hormuz. IEA record 400M SPR FAILED. Brent $101. LPG FORCE MAJEURE by OMCs. Russian oil +50%. War cost $11.3B/6 days. US admits Tomahawk school strike. Ukraine teams in Gulf. UNSC voting. 634 killed Lebanon, 750K displaced. WHO: toxic black rain.",
  },
  {
...
const GEOPOLITICAL_CHALLENGES = [
  {
    ...
    items: [
      ...
      { text: "Brent: $120→$84 (Tue relief)→$93 (Wed ships hit)→$101 (Thu). IEA record 400M SPR = NOT ENOUGH. 16 Iran minelayers destroyed. US destroyed 5,000+ targets. War cost $11.3B in 6 days. WTI $101. US gas $3.45/gal (+43c). Rapidan: could test $120 in 2 wks. CSIS: Epic Fury costs $891M/DAY ($3.7B total so far)", metric: "$78", unit: "Brent Tue" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "WAR RE-ESCALATED: Iran MOST INTENSE operation. IRGC+Hezbollah JOINT 5hr attack on 50+ Israeli targets. 3 ships hit Hormuz. IRGC fired on vessels ignoring warnings. War cost $11.3B/6 days", metric: "⚡", unit: "escalation" },
      { text: "India: OMCs declared LPG FORCE MAJEURE. Russian oil +50%. Ukraine teams in Gulf. IEA 400M SPR FAILED. UNSC voting on GCC anti-Iran resolution. 52K Indians returned but 9M still in Gulf", metric: "9M+", unit: "citizens" },
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff1744" }}>DAY 13 — IEA RECORD SPR RELEASE FAILED, WAR RE-ESCALATES:</strong> IEA announced record 400M barrel SPR release (US 172M) — Brent STILL back above $100 ($101.53 Thu). Tuesday relief rally (+727 Sensex) FULLY ERASED Wednesday (-1,342). Iran launched "most intense operation since war" — IRGC+Hezbollah JOINT 5-hour attack striking 50+ Israeli targets. 3 ships attacked near Hormuz (Japanese, Thai, Marshall Islands flags). IRGC navy fired on 2 vessels ignoring stop warnings. Tehran says 10,000 civilian sites bombed, 1,300+ killed. Lebanon: 634 killed, 750,000 displaced. WHO warns of toxic BLACK RAIN from oil depot strikes. War cost $11.3B in first 6 days ($1.5B+/day — Pentagon briefing). US investigating school Tomahawk strike. Ukraine anti-drone teams now deployed in Qatar/UAE/Saudi. 16 Iranian minelayers destroyed near Hormuz. US destroyed 5,000+ Iranian targets. UNSC voting on GCC resolution against Iran. Mojtaba Khamenei suffered fractured foot in initial strikes (CNN). IRGC: deploying heavier warheads >1 tonne.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff9100" }}>INDIA: SPR FAILED, LPG CRISIS DEEPENING:</strong> Sensex 76,435 (-429 Thu, after Tue +727 erased by Wed -1,342). Nifty 23,725 (-142). Rupee NEW ALL-TIME LOW 92.37/$. Brent back >$100 DESPITE IEA record 400M barrel SPR release. OMCs declared LPG FORCE MAJEURE — commercial supply stopped Mumbai/Bengaluru, restaurants facing closure. OMC stocks HPCL/BPCL/IOC crashed 19% in March. FPIs sold ₹32,849 cr in Mar. 693 stocks hit 52-week lows. Nifty down 5% in 7 sessions, still in correction zone (10% off record). India's Russian oil purchases surged 50% as scramble to replace Gulf barrels intensifies. Auto -3% Wed. Induction stove stocks +15% on LPG crisis. Medicine prices may surge (pharma raw materials costlier). Brent ranged $84-$120 this week = UNPRECEDENTED volatility making risk pricing impossible.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ffea00" }}>HUMANITARIAN + DOMESTIC CRISIS:</strong> Lebanon: 634 killed (83 children), 750,000 displaced — "unprecedented" pace (UN). WHO: toxic black rain from oil depot strikes poses health risks across Iran. 52,000 Indians returned Mar 1-7 but 9M still in Gulf. LPG FORCE MAJEURE by Indian OMCs — commercial supply stopped in Mumbai, Bengaluru, threatening restaurant/hotel sector. Iran police chief: protesters will be treated as "enemies." Iran kicked out of FIFA World Cup (reports). 5 Iranian women footballers granted asylum in Australia. Ukraine anti-drone teams deployed in Qatar, UAE, Saudi Arabia. UNSC voting on GCC resolution demanding Iran stop attacking neighbors. US admits investigating Tomahawk strike on school. Senate Dems "horrified." War cost US $11.3B in 6 days ($1.5B+/day). Rogan: Trump "betrayed" no-war promise.</p>
                <p style={{ margin: 0 }}>
                  <strong style={{ color: "#00e5ff" }}>13-DAY TRAJECTORY — SPR EXHAUSTION + ATTRITION:</strong> Oil: $65→$120→$84→$101 (IEA 400M SPR release FAILED to hold prices). Deaths: 555→1,045→1,332 Iran + 634 Lebanon = 1,966+ total. IRGC launching "most intense" operations. Joint Iran+Hezbollah attacks. Ships attacked in Hormuz. NO de-escalation despite Trump signals. Cost: $11.3B in 6 days, "well above $1.5B/day" now (Sen. Coons). India's FIVE CRISES NOW CHRONIC: (1) ENERGY: IEA 400M SPR = last resort, prices STILL >$100. LPG force majeure. Russian oil +50%; (2) FISCAL: Rupee 92.37 ATL. OMCs -19%. FPIs -₹32,849 cr; (3) MARKETS: Nifty -5% in 7 sessions. 693 stocks at 52-wk lows. Correction zone; (4) TRADE: 400K tons rice stuck. Hormuz vessels being fired on. Shipping impossible; (5) SOCIAL: LPG supply stopped. Medicine prices rising. 750K displaced Lebanon. THIS IS NOW A SUSTAINED CRISIS — not a shock. India must plan for $90-110 Brent for months, not weeks.</p>
              </div>
            </div>
          </div>
        )}

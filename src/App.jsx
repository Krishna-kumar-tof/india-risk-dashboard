...
const LAST_UPDATED = "March 10, 2026 — 11:46 AM IST (Day 11 • Brent $88 • RELIEF RALLY)";
...
const INDIA_REGIONS = [
  ...
  },
  {
    ...
    tag: "HIGH",
    detail: "CONFLICTING SIGNALS Tue: Trump says war very complete BUT IRGC deploys >1T warheads + Kharazi rules out diplomacy + Russia giving Iran intel. Brent $120→$88 ($30 swing). LPG CRISIS: commercial supply stopped Mumbai/Bengaluru. 52,000 Indians returned. Israeli CoS: war will take long time. Macron: Cyprus attack = Europe attacked. Senate Dems horrified by school strike. 5 Iranian women footballers seek asylum Australia.",
  },
  {
...
const GEOPOLITICAL_CHALLENGES = [
  {
    ...
    items: [
      ...
      { text: "Brent swung $120→$88 in 24hrs ($30 drop — extreme volatility). Trump signals de-escalation but IRGC rejects. Russia giving Iran intel (AP). LPG commercial supply STOPPED Mumbai/Bengaluru. WTI $101. US gas $3.45/gal (+43c). Rapidan: could test $120 in 2 wks. CSIS: Epic Fury costs $891M/DAY ($3.7B total so far)", metric: "$78", unit: "Brent Tue" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "CONFLICTING SIGNALS: Trump says war very complete, could end soon. BUT IRGC rejects, says >1T warheads ready. Kharazi: prepared for LONG WAR, no diplomacy. Russia giving Iran intel (AP)", metric: "⚡", unit: "escalation" },
      { text: "52,000 Indians returned. LPG CRISIS: commercial supply STOPPED in Mumbai/Bengaluru. 5 Iranian women footballers seek asylum in Australia. Macron: Cyprus attack = attack on Europe. Israeli CoS: war will take long", metric: "9M+", unit: "citizens" },
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff1744" }}>DAY 11 — DRAMATIC $30 OIL SWING, RELIEF RALLY BUT WAR NOT OVER:</strong> Brent CRASHED from $120 to $88 overnight (−$30 — largest single-session swing in years) after Trump said war objectives "very complete" and could end "very soon." Sensex REBOUNDS +810 to 78,376. Nifty +253 to 24,281. VIX -15%. Nikkei +2%. Kospi rallying. BUT CRITICAL CONTRADICTION: IRGC REJECTS US claims, says deploying missiles with warheads >1 TONNE in greater numbers. Iran advisor Kharazi told CNN: prepared for LONG WAR, rules out diplomacy. Russia giving Iran intelligence to hit US targets (AP). Israeli CoS: war will take a LONG TIME. Trump ALSO threatened to hit Iran "20 times harder" if Hormuz blocked. DEATH TOLL: 1,332+ Iran + 394 Lebanon (83 children) + 11 Israel + 8 US + 9+ Gulf = 1,754+. LPG CRISIS: commercial cylinder supply STOPPED in Mumbai, Bengaluru. 5 Iranian women footballers seeking asylum in Australia. Macron: attack on Cyprus = attack on Europe.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff9100" }}>INDIA: RELIEF RALLY BUT DAMAGE IS DONE:</strong> Sensex +810 to 78,376 (Tue open) after Mon crash to 76,425. Nifty +253 to 24,281. VIX -15% to 19.80. Aviation/paint stocks recovering. BUT: ₹38L+ cr ALREADY wiped. Nifty STILL in 10% correction from record. FII sold ₹21,831 cr in Mar (₹6,030 cr Mon alone). Rupee closed 92.33 Mon (ATL territory). LPG CRISIS NOW: commercial cylinder supply STOPPED in Mumbai and Bengaluru — may lead to restaurant/hotel closures (News24). Brent at $88 = relief vs $120, but STILL +35% from pre-war $65. At $88: petrol pressure remains, CAD still widened, RBI still constrained. EXTREME VOLATILITY: $30 swing in 24hrs means no one can price risk. UBS still has OMCs downgraded. Nomura: FMCG margins at risk. Jaishankar warned of supply chain disruption. War NOT over despite Trump signals.</p>
                <p style={{ margin: "0 0 6px" }}>
                ...
                <p style={{ margin: 0 }}>
                  <strong style={{ color: "#00e5ff" }}>11-DAY ASSESSMENT — WAR AT INFLECTION POINT:</strong> CONFLICTING SIGNALS: Trump says objectives very complete BUT IRGC deploys >1T warheads + Kharazi rules out diplomacy + Russia giving Iran intel + Israeli CoS says war will take long time. Oil: $65→$120→$88 (EXTREME volatility). Deaths: 1,754+ total (1,332 Iran, 394 Lebanon). India's FIVE CRISES — MIXED: (1) ENERGY: Brent $88 (relief from $120 but still +35% pre-war). LPG CRISIS — commercial supply stopped Mumbai/Bengaluru; (2) FISCAL: ₹38L+ cr wiped. Rupee 92.33. LPG +₹60. Petrol pressure remains; (3) MARKETS: Relief rally Tue but Nifty still in correction zone. FII sold ₹21,831 cr; (4) TRADE: 400K tons rice stuck. Hormuz situation unclear; (5) SOCIAL: 52K evacuated, LPG crisis now hitting cities directly. KEY QUESTION: Is this a genuine de-escalation or a pause before next phase? IRGC and Israeli military both say war continues. India MUST NOT be lulled by one day's relief — prepare for sustained $80-120 oil volatility for weeks.</p>
              </div>
            </div>
          </div>
        )}

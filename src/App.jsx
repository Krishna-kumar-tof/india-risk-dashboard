...
const INDIA_REGIONS = [
  ...
  },
  {
    ...
    immediate: 99, shortterm: 95, medterm: 88, longterm: 80,
    tag: "CRITICAL",
  ...
  },
  {
    ...
    tag: "HIGH",
    detail: "MOJTABA KHAMENEI elected 3rd Supreme Leader (Mar 8). Iran FM rejects ceasefire. Hegseth: 500-2000lb bombs next phase. NIC: war unlikely to topple regime. CSIS: war costs $891M/day. 52,000 Indians returned. Kashmir schools reopened Mar 7. But Brent $108 = fiscal emergency. Thu nuclear diplomacy signal caused brief rally (+900 pts) — erased Fri. Oil at $108 worst since 2008 for India macro.",
  },
  {
...
const GEOPOLITICAL_CHALLENGES = [
  {
    ...
    items: [
      ...
      { text: "Brent $108→$115 (Sun night). WTI $113. US crude +35% last wk (biggest since 1983). 20M bbl/day removed from circulation. WTI $101. US gas $3.45/gal (+43c). Rapidan: could test $120 in 2 wks. CSIS: Epic Fury costs $891M/DAY ($3.7B total so far)", metric: "$78", unit: "Brent Tue" },
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff1744" }}>DAY 10 — OIL $108, WAR ENTERS WEEK 2:</strong> Brent hits $108 Sun night (first >$100 since Jul 2022, +55% since war). Rapidan: 20% global oil supply disrupted 9 DAYS RUNNING (2x Suez Crisis record). Israel struck IRANIAN OIL DEPOTS for first time (Shahran, Shar Rey — blackened rain on Tehran). MOJTABA KHAMENEI elected 3rd Supreme Leader. IRGC pledges allegiance. Iran FM REJECTS ceasefire. DEATH TOLL: 1,332+ Iran, 50+ Lebanon, 11 Israel, 8 US, 7 Gulf = 1,408+ TOTAL. Saudi FIRST deaths (2 killed + 12 injured, residential). Israel: 2,500 strikes, 80% air defense destroyed, near-complete air superiority. Hegseth: 500-2000lb gravity bombs NEXT PHASE. HRW: school strike = war crime. UN declares major humanitarian emergency (25M refugees). NIC report: war unlikely to topple Iran. CSIS: war costs $891M/day ($3.7B total). Pope, Switzerland condemn. China: flames of war risk spreading.</p>
                <p style={{ margin: "0 0 6px" }}>
                  <strong style={{ color: "#ff9100" }}>INDIA FISCAL EMERGENCY AT $108 OIL:</strong> WORST WEEK IN 1 YEAR: Sensex 78,919 (-3%), Nifty 24,450 (-3%, Apr 2025 low). Thu relief rally (+900 pts on Iran nuclear diplomacy signal) ERASED Fri. Rupee hit 92.30 ATL Wed (recovered 91.54 Thu on RBI intervention). FII sold ₹7,048 cr in week. BRENT $108→$115 Sun night. WTI $113. Dow futures -1,026. US crude +35% LAST WEEK (biggest weekly gain since 1983). At $108: (a) every $10/bbl rise = CAD +50bps, (b) petrol ₹100+/L imminent, (c) OMC losses unsustainable, (d) RBI rate cut hopes dead, (e) rupee likely retests 92-93 zone. US gas $3.45/gal (+43c since war). Rapidan: $120 possible in 2 weeks. US issued 30-day waiver for Russian crude in transit — lifeline for India? Sensex -7% YTD, Nifty -6% YTD. FII sold ₹1.66L cr in 2025 + continuing 2026.</p>
                <p style={{ margin: "0 0 6px" }}>
                ...
                <p style={{ margin: 0 }}>
                  <strong style={{ color: "#00e5ff" }}>10-DAY TRAJECTORY — NO EXIT RAMP:</strong> Death toll: 555→787→1,045→1,332. Oil: $78→$84→$87→$94→$108. Iran capability: missiles -90%, drones -83%, navy destroyed, 80% air defense gone — BUT new Supreme Leader, ceasefire rejected, ground forces engaged. WAR IS ENTERING ATTRITION PHASE. India's FIVE CRISES now at CRITICAL: (1) ENERGY: Brent $108 (55% surge). 8-wk buffer depleting. Qatar LNG halted. $120 in 2 wks possible; (2) FISCAL: Each $10 rise = CAD +50bps. Petrol ₹100+ imminent. OMC losses unsustainable. RBI rate cuts impossible; (3) MARKETS: Worst week in 1 yr. Nifty at Apr 2025 low. FII exodus. GIFT Nifty -300 for Mon; (4) TRADE: 400K tons rice stuck. Hormuz near-total halt. Shipping 8x cost; (5) SOCIAL: 52K returned but 9M in Gulf. Saudi now taking casualties. India MUST: (a) activate Russian crude waiver urgently, (b) emergency SPR release, (c) prepare for petrol price hike or fiscal blowout, (d) scale evacuation, (e) plan for prolonged $100+ oil scenario — war is entering Week 2 with zero de-escalation signals.</p>
              </div>
            </div>
          </div>
        )}
